        ...
        <>
            ...
            <div className="container mt-4">
                ...
                <ul style={{ textAlign: "justify" }} className="list-unstyled">
                    <li><h5><b>Discovery of Polonium and Radium (1898)</b>:</h5>
                    ...
                    <br />
                    <li><h5><b>Doctoral Thesis on Radioactive Substances (1903)</b>:</h5>
                    ...
                    <br />
                    <li><h5><b>Work on the Properties and Decay of Radium</b>:</h5>
                    ...
                    <br />
                    <li><h5><b>Applications of Radiation in Medicine</b>:</h5>
                    ...
                    <br />
                    <li><h5><b>Wartime Research (1914-1919)</b>:</h5> During World War I, Marie Curie developed portable X-ray devices (called “petites Curies”) for battlefield diagnostics.</li>
                </ul>
