...
import hinhBioone1 from '../Img/Van/bioone/hinhBioone1.jpg'
                                ...
                                <div className='Van-Bioone-clickme'>
                                    <Figure>
                                        <Figure.Image
                                            ...
                                            src={fiveyears} />
                                        <Figure.Caption>
                                            <span style={{ color: '#F2F2CE' }}> CLICK ME</span>
                                        </Figure.Caption>
                                    </Figure>
                                </div>
                            </ListGroup.Item>
                    ...
                    <Col sm={6}>
                        <Tab.Content>
                            ...
                            <Tab.Pane eventKey="#link2">
                                <div id='link2' style={{ textAlign: "justify", fontSize: "1.25rem" }} className='chuhoa'>
                                    <h1 className="text-center mb-4" data-aos="slide-right" style={{ backgroundColor: ' #F2F2CE', borderRadius: '1000px' }} > Her education </h1>

                                    <p style={{ color: ' #F2F2CE', fontSize:'1.19rem' }} >Marie always holds the top position in schools in the years of school when she was ten years old, Maria started attending J. Sikorska boarding school; After that, she attended a high school for girls, where she graduated on June 12, 1883 with the gold medal. Warsaw, the school is only for male students. The Russian Empire prohibits women from attending college. She and her sister Bronisława participated in secret flight college, a Polish patriotic higher education organization to receive female students.</p>
                                    <p style={{ color: ' #F2F2CE', fontSize:'1.19rem' }} >Maria agreed with her sister, Bronisława, that she would financially support Bronisława during medical time in Paris, in exchange for the same support two years later. Regarding this, Maria received a first place, a tutor at Warsaw, then a tutor for two years in Szczuki with a family of Dien Trang, the family żorawskis, her father's relatives. While working for her family later, she loved their son, Kazimierz żorawski, a prominent mathematician in the future. His parents protested the idea he married a poor relative, and Kazimierz could not object to them. Mary's loss of relationship with żorawski is a tragedy for both. He soon got a doctorate and pursued an academic career as a mathematician, becoming a professor and principal of Kraków University. However, as an old man and a mathematical professor at Warsaw University of Technology, he still sat down in front of the Maria Skłodowska statue built in 1935 before the Radium Institute, where she was founded in the year. 1932. </p>
                                    {/*  */}
                                </div >
                            </Tab.Pane>
                            <Tab.Pane eventKey="#link3">
                                <div id='link3' style={{ textAlign: "justify", fontSize: "1.25rem" }} className='chuhoa'>
                                    <h1 className="text-center mb-4" data-aos="slide-right" style={{ backgroundColor: ' #F2F2CE', borderRadius: '1000px' }} > Marie Curie's efforts and struggles </h1>
                                    <p style={{ color: ' #F2F2CE', fontSize:'1.19rem' }} >While working as a tutor, she continued to self-study and research whenever she had time.</p>
                                    <p style={{ color: ' #F2F2CE', fontSize:'1.19rem' }} > In 1891, when Maria was 24 years old, she was finally able to move with her sister to Paris and now used the name Marie. She enrolled at the University of Paris—called the Sorbonne—where she studied physics and mathematics, starting her path into scientific research.</p>
                                    <p style={{ color: ' #F2F2CE',fontSize:'1.19rem' }} > Shortly after arriving in Paris, thanks to her extraordinary efforts, Marie quickly became one of the most outstanding students at the Sorbonne University. While still a third-year student, she was awarded a master's degree in physics. And in her fourth year, she was awarded a master's degree in arithmetic. In addition, Marie also spoke and wrote in languages ​​such as French, Russian, English, German and was determined to do a doctoral thesis in Physics.</p>
                                    <p style={{ color: ' #F2F2CE', fontSize:'1.19rem' }} > She studied the magnetic properties of alloys and wrote the first scientific project here.</p>
                                </div>
                                {/* <div className='Van-khoitron-quot' >
                                <Figure>
                                    <Figure.Image
