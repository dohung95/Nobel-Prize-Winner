...
function Biothree() {
    ...
    return (
        <>
            <h1 className="text-center mb-4" data-aos="fade-up" style={{ backgroundColor: ' #F2F2CE', borderRadius: '1000px', color: 'black' }}>
                Timeline about Marie Curie's life from 1906 to 1914
            </h1>
            {isMobile ? (
                <select onChange={handleSelectChange} className="form-select mb-4">
